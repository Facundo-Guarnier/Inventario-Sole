      ...
      next: (data) => {
        ...
        this.datos = Object.values(data["productos"]).flat().map((producto: any) => {
          ...
          if (productoModificado.fisica.validacion) {
            productoModificado.ultima_fecha = productoModificado.fisica.validacion.ultima_fecha;
            ...
            if (productoModificado.ultima_fecha !== this.fecha_ronda) {
              ...
              productoModificado.cantidad_validada = productoModificado.fisica.validacion.cantidad_validada;
              productoModificado.estado = productoModificado.fisica.validacion.estado;
            }
