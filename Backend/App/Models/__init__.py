...
#* MODELS consiste en la estructura de los datos que se van a manejar en la aplicacion y la forma en que se interactua con la base de datos

from .GiftCard import GiftCard as GiftCardModel
