...
class MercadoLibreAPI:
    ...
    def publicar_producto(self):
        picture_paths = [
            "/home/guarnold/Repositorios_GitHub/Inventario-Sole/Backend/uploads/00001/resized_1.png"
        ]
        ...
        "attributes": [
            {
                "id": attribute_id,
                "value_name": "Mujer",
            }  # Asegúrate de proporcionar los valores apropiados para cada atributo requerido
            for attribute_id in required_attributes
        ]
    }
    #! Consultar la ficha técnica de la guía de talles
    grid_technical_specs_response = ml_api.post(
