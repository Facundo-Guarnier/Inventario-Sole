          ...
          .map((producto: any) => {
            ...
            if (productoModificado.online) {
              productoModificado.cantidad_fisica =
                productoModificado.online.cantidad;
            }

            if (productoModificado.online.validacion) {
              productoModificado.ultima_fecha =
                productoModificado.online.validacion.ultima_fecha;
              ...
              if (productoModificado.ultima_fecha !== this.fecha_ronda) {
                ...
                productoModificado.cantidad_validada =
                  productoModificado.online.validacion.cantidad_validada;
                productoModificado.estado =
                  productoModificado.online.validacion.estado;
              }
